          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-[#3B82F6]/30 hover:border-[#3B82F6] transition-all duration-300">
            <div className="flex items-start gap-4">
              <div className="bg-[#3B82F6]/20 p-4 rounded-lg">
                <svg className="w-8 h-8 text-[#3B82F6]" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-[#FFCC00]/30 hover:border-[#FFCC00] transition-all duration-300">
            <div className="flex items-start gap-4">
              <div className="bg-[#FFCC00]/20 p-4 rounded-lg">
                <svg className="w-8 h-8 text-[#FFCC00]" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-slate-500/30 hover:border-slate-400 transition-all duration-300">
            <div className="flex items-start gap-4">
              <div className="bg-slate-600/30 p-4 rounded-lg">
                <svg className="w-8 h-8 text-gray-300" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-[#D50032]/30 hover:border-[#D50032] transition-all duration-300">
            <div className="flex items-start gap-4">
              <div className="bg-[#D50032]/20 p-4 rounded-lg">
                <svg className="w-8 h-8 text-[#D50032]" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start gap-4">
                <div className="bg-[#3B82F6]/20 p-3 rounded-lg">
                  <svg className="w-6 h-6 text-[#3B82F6]" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start gap-4">
                <div className="bg-[#FFCC00]/20 p-3 rounded-lg">
                  <svg className="w-6 h-6 text-[#FFCC00]" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24">
